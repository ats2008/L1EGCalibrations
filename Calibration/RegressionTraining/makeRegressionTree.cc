   ...
   // if(i%4) continue;
    ...
    intree->GetEntry(i);
      ...
      if( _ele_L1Stage2_emul_rawEt>0 )
      {
        ...
        if (_target>6.0) continue;
        if (_target<0.1) continue;
